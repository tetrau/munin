...
class TestMunin(unittest.TestCase):
    ...
    def test_cache(self):
        r = self.session.get("https://www.example.com", wait=1)
        text = r.text
    ...
    def test_get_multi_cache(self):
        self.session.get("https://www.example.com", wait=1)
        self.session.get("https://www.example.com", use_cache=False, wait=1)
